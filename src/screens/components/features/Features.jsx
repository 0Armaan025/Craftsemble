    ...
    <>
        <div className="features">
            ...
            <div className="featuresRow">
                ...
                <FeatureCard featureName="Under Development" featureImage="https://plus.unsplash.com/premium_photo-1682617326998-776d7443f02c?auto=format&fit=crop&q=60&w=600&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGNvbnN0cnVjdGlvbnxlbnwwfHwwfHx8MA%3D%3D" featureDescription="NOTE: this website is in construction progress, after Nov 4(end of this hackathon), the work will be resumed again irrespective of winning or losing. "/>
                <FeatureCard featureName="Updates?" featureImage="https://images.unsplash.com/photo-1550418290-a8d86ad674a6?auto=format&fit=crop&q=60&w=600&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHVycG9zZXxlbnwwfHwwfHx8MA%3D%3D" featureDescription="the website is created with an intention to remember about unsung creators (our craftsemn and artisans), the old ancient art which is still not too famous unlike our digital art? I mean, that should be fetaured too, right? they work hard as well! + they have been doing this for years!!!, also, all bugs you see on the website are features ;), this all will be updated super soon! thanks : D "/>
