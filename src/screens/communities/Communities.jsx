  ...
  return (
    <>
       <div className="communities">
        ...
        <br/>
        <br/>
            <h1 className="communitiesHeading" style={{color: "black"}}>Let's explore some of the communities!</h1>
            <center><h5>Wanna have your listed here!? You can do that <Link to="/list-a-community">HERE</Link></h5></center>
            <br/>
